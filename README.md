...
- HMRC: HMRC_CLIENT_ID, DIY_SUBMIT_HMRC_CLIENT_SECRET, HMRC_BASE_URI, DIY_SUBMIT_BASE_URL
- Cognito/Google: COGNITO_CLIENT_ID, COGNITO_BASE_URI, DIY_SUBMIT_GOOGLE_CLIENT_ID, DIY_SUBMIT_GOOGLE_CLIENT_SECRET
