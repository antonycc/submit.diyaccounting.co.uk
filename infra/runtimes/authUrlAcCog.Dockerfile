...
ENV DIY_SUBMIT_AC_COG_BASE_URI="The default value from the Dockerfile is intended to be overridden."
ENV DIY_SUBMIT_AC_COG_CLIENT_ID="The default value from the Dockerfile is intended to be overridden."
