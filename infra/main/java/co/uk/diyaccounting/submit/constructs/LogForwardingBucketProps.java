...
public class LogForwardingBucketProps implements StackProps {
    ...
    public static class Builder {
        ...
        public Builder bucketName(String v) {
            this.bucketName = v;
            return this;
        }

        public Builder functionNamePrefix(String v) {
            this.functionNamePrefix = v;
            return this;
        }

        public Builder retentionPeriodDays(int v) {
            this.retentionPeriodDays = v;
            return this;
        }
        ...
        public Builder removalPolicy(RemovalPolicy v) {
            this.removalPolicy = v;
            return this;
        }
        ...
        public Builder blockPublicAccess(BlockPublicAccess v) {
            this.blockPublicAccess = v;
            return this;
        }

        public Builder autoDeleteObjects(boolean v) {
            this.autoDeleteObjects = v;
            return this;
        }

        public Builder objectOwnership(ObjectOwnership v) {
            this.objectOwnership = v;
            return this;
        }

        public LogForwardingBucketProps build() {
            return new LogForwardingBucketProps(this);
        }
    }
}
