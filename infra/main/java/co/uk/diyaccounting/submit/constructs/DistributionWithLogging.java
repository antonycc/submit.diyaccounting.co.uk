...
public class DistributionWithLogging {
    ...
    private DistributionWithLogging(Builder b) {
        ...
        IBucket distAccess = LogForwardingBucket.Builder
                .create(b.scope, "DistributionAccess", b.logHandlerSource, LogGzippedS3ObjectEvent.class)
    ...
    public static class Builder {
        ...
        public Builder additionalBehaviors(Map<String, BehaviorOptions> additionalBehaviors) { this.additionalBehaviors = additionalBehaviors; return this; }
        public Builder defaultRootObject(String defaultRootObject) { this.defaultRootObject = defaultRootObject; return this; }
        public Builder errorPageKey(String errorPageKey) { this.errorPageKey = errorPageKey; return this; }
        public Builder errorStatusCode(int code) { this.errorStatusCode = code; return this; }
        public Builder certificate(ICertificate certificate) { this.certificate = certificate; return this; }
        public Builder logBucketName(String name) { this.logBucketName = name; return this; }
        public Builder logFunctionNamePrefix(String prefix) { this.logFunctionNamePrefix = prefix; return this; }
        public Builder logRetentionDays(int days) { this.logRetentionDays = days; return this; }
        public Builder cloudTrailEnabled(boolean enabled) { this.cloudTrailEnabled = enabled; return this; }
        public Builder logIncludesCookies(boolean includes) { this.logIncludesCookies = includes; return this; }
        public Builder logHandlerSource(String source) { this.logHandlerSource = source; return this; }

        public DistributionWithLogging build() {
            if (domainName == null || domainName.isBlank()) throw new IllegalArgumentException("domainName is required");
            ...
            if (logBucketName == null || logBucketName.isBlank()) throw new IllegalArgumentException("logBucketName is required");
            if (logFunctionNamePrefix == null || logFunctionNamePrefix.isBlank()) throw new IllegalArgumentException("logFunctionNamePrefix is required");
            if (logHandlerSource == null || logHandlerSource.isBlank()) throw new IllegalArgumentException("logHandlerSource is required");
