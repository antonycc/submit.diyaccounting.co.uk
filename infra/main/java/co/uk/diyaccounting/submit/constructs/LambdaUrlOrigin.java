...
public class LambdaUrlOrigin {
  ...
  private LambdaUrlOrigin(Builder builder) {
    ...
    // Create function URL
    FunctionUrlOptions.Builder functionUrlOptionsBuilder =
    ...
    this.apiOrigin =
        HttpOrigin.Builder.create(lambdaUrlHost).protocolPolicy(builder.protocolPolicy).build();

    BehaviorOptions.Builder behaviorOptionsBuilder =
  ...
  public static class Builder {
    ...
    public IOriginRequestPolicy originRequestPolicy =
