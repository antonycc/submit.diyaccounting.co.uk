...
public class GitHubOIDCRoles extends Stack {
    ...
    public GitHubOIDCRoles(Construct scope, String id, StackProps props, Builder builder) {
        ...
        testConditions.put("StringEquals", Map.of(
            "token.actions.githubusercontent.com:aud", "sts.amazonaws.com",
            "token.actions.githubusercontent.com:sub", "repo:" + builder.repositoryName + ":ref:refs/heads/main"
        ));

        this.testRole = Role.Builder.create(this, "GitHubTestRole")
                .roleName("submit-test-role")
                .description("Limited role for GitHub Actions testing - read-only access to S3 artifacts and receipts")
                ...
                .inlinePolicies(Map.of(
                    "TestPermissions", software.amazon.awscdk.services.iam.PolicyDocument.Builder.create()
                        .statements(List.of(
        ...
        deployConditions.put("StringEquals", Map.of(
            "token.actions.githubusercontent.com:aud", "sts.amazonaws.com",
            "token.actions.githubusercontent.com:sub", "repo:" + builder.repositoryName + ":ref:refs/heads/main"
        ));
        ...
        this.deploymentRole = Role.Builder.create(this, "GitHubDeploymentRole")
                ...
                .inlinePolicies(Map.of(
                    "CDKDeploymentPermissions", software.amazon.awscdk.services.iam.PolicyDocument.Builder.create()
                        .statements(List.of(
