...
public class GitHubOIDCRoles extends Stack {
  ...
  public GitHubOIDCRoles(Construct scope, String id, GitHubOIDCRolesProps props) {
    ...
    this.oidcProvider =
        OpenIdConnectProvider.Builder.create(this, "GitHubOIDCProvider")
    ...
    this.testRole =
        Role.Builder.create(this, "GitHubTestRole")
            ...
            .description(
                "Limited role for GitHub Actions testing - read-only access to S3 artifacts and"
                    + " receipts")
            .assumedBy(
    ...
    this.deploymentRole =
        Role.Builder.create(this, "GitHubDeploymentRole")
            ...
            .description(
                "Full deployment role for GitHub Actions - CDK and AWS resource management")
            .assumedBy(
                new FederatedPrincipal(
                    this.oidcProvider.getOpenIdConnectProviderArn(),
                    deployConditions,
