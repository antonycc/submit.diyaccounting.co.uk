...
// injectMockMfa and clearMockMfa are no longer needed — MFA metadata is now set by the
// login callback itself via amr claims (mock OAuth2 server) or identities+auth_time (federated IdPs).
// See loginWithCognitoCallback.html and loginWithMockCallback.html for the detection logic.
//
// /**
