...
public class LogS3ObjectTest {
    ...
    public void expectHandlerToLogEvent() throws IOException {
        ...
        when(mockS3.getObjectContentAsString(mockEvent.getRecords().get(0).getS3())).thenReturn(objectContents);
    ...
    public void expectHandlerToLogException() throws IOException {
        ...
        when(mockContext.getLogger()).thenReturn(mockLogger);
        S3 mockS3 = Mockito.mock(S3.class);
        when(mockS3.getObjectContentAsString(mockEvent.getRecords().get(0).getS3())).thenThrow(exception);
