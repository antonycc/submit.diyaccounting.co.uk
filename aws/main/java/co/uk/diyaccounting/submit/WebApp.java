...
public class WebApp {
    public static void main(final String[] args) {
        ...
        WebStack stack = WebStack.Builder.create(app, stackId)
                ...
                .testAccessToken(System.getenv("DIY_SUBMIT_TEST_ACCESS_TOKEN"))
                .testS3Endpoint(System.getenv("DIY_SUBMIT_TEST_S3_ENDPOINT"))
                .testS3AccessKey(System.getenv("DIY_SUBMIT_TEST_S3_ACCESS_KEY"))
                .testS3SecretKey(System.getenv("DIY_SUBMIT_TEST_S3_SECRET_KEY"))
