...
The script:
- Reads bundle timeout from web/public/submit.catalogue.toml
...
- web/public/submit.catalogue.toml file in repository root
...
Ensure the bundle exists in web/public/submit.catalogue.toml with a valid timeout:
- `P1D` - 1 day
- `P1M` - 1 month
- `P1Y` - 1 year
