...
find . -type f | grep -v '.env\|.DS_Store\|.git\|.idea\|.junie\|.mvn\|.run\|target\|_developers\|node_modules\|prompts\|wiremock-recordings\|.png\|web.iml\|hmrc-test-user.json\|package-lock.json' \
