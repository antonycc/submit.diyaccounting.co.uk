...
export function getHmrcErrorMessage(errorCode, errorDetails = {}) {
  const errorMap = {
    ...
    'VRN_NOT_FOUND': {
      ...
      userGuidance: 'The VAT Registration Number (VRN) could not be found in HMRC records. Please verify the VRN is correct and that the business is registered for VAT.',
      httpStatus: 404,
    },
    ...
    'INVALID_PERIOD_KEY': {
      ...
      userGuidance: 'The period key provided is not in the correct format. Period keys should be in the format like "24A1" (year + quarter) or as provided in your VAT obligations.',
      httpStatus: 400,
    },
    'PERIOD_KEY_INVALID': {
      message: 'Invalid period key',
      userGuidance: 'The period key provided is not valid for this VAT Registration Number. Please check your VAT obligations to find the correct period key.',
      httpStatus: 400,
    },
    'DATE_RANGE_TOO_LARGE': {
      message: 'Date range too large',
      userGuidance: 'The date range specified is too large. HMRC typically allows a maximum of 4 years for obligation queries. Please reduce the date range and try again.',
      httpStatus: 400,
    },
    'INVALID_DATE_FROM': {
    ...
    'DUPLICATE_SUBMISSION': {
      ...
      userGuidance: 'A VAT return has already been submitted for this period. You cannot submit the same period more than once. If you need to correct a submission, contact HMRC.',
      httpStatus: 409,
    },
    'INVALID_SUBMISSION': {
      message: 'Invalid submission data',
      userGuidance: 'The VAT return data provided is invalid. Please check that all required fields are present and contain valid numeric values.',
      httpStatus: 400,
    },
    'NOT_FINALISED': {
    ...
    'INSOLVENT_TRADER': {
      ...
      userGuidance: 'VAT returns cannot be submitted for this business as it is marked as insolvent in HMRC records. Please contact HMRC for assistance.',
      httpStatus: 403,
    },
    'NOT_FOUND_VRN': {
      message: 'VAT Registration Number not found',
      userGuidance: 'The VAT Registration Number is not found or not active in HMRC records. Please verify the VRN and business registration status.',
      httpStatus: 404,
    },
    'INVALID_PERIODKEY': {
    ...
    'CLIENT_OR_AGENT_NOT_AUTHORISED': {
      ...
      userGuidance: 'You are not authorized to access VAT information for this VAT Registration Number. Please ensure you have the correct permissions and are logged in with the appropriate credentials.',
      httpStatus: 403,
    },
    'AGENT_NOT_SUBSCRIBED': {
      message: 'Agent not subscribed',
      userGuidance: 'If you are an agent, you must be subscribed to the Agent Services Account. Please visit HMRC to complete your agent subscription.',
      httpStatus: 403,
    },
    ...
    'NO_OBLIGATIONS_FOUND': {
      ...
      userGuidance: 'No VAT obligations were found for the specified date range and status. Try expanding your date range or checking a different status (Open/Fulfilled).',
      httpStatus: 404,
    },
    'INVALID_STATUS': {
    ...
    'SERVICE_UNAVAILABLE': {
      ...
      userGuidance: 'The HMRC service is temporarily unavailable. Please try again in a few minutes. HMRC services may be undergoing maintenance.',
      httpStatus: 503,
    },
    'GATEWAY_TIMEOUT': {
